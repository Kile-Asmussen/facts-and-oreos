//! FFI bindings to FLua (Factorio's Lua 5.2).
//!
//! Based on mlua-sys src/lua52/lua.rs, extended with FLua-specific API additions.
...
unsafe extern "C-unwind" {
    ...
    // FLua extensions: stricter type checks that do not coerce
...
unsafe extern "C-unwind" {
    ...
    // FLua extension: length-aware field get, avoids strlen on the key
    ...
    // FLua extension: length-aware field set, avoids strlen on the key
